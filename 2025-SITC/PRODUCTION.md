...
```ini
[Unit]
Description=SITC 2025 Conference Abstract Annotator
...
User=www-data
Group=www-data
WorkingDirectory=/var/www/conference-webapp/2025-SITC
...
server {
    ...
    location /static {
        alias /var/www/conference-webapp/2025-SITC/static;
        expires 30d;
