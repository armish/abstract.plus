...
```ini
[Unit]
Description=ASCO 2026 Conference Abstract Annotator
...
User=www-data
Group=www-data
WorkingDirectory=/var/www/conference-webapp/2026-ASCO
...
server {
    ...
    location /static {
        alias /var/www/conference-webapp/2026-ASCO/static;
        expires 30d;
